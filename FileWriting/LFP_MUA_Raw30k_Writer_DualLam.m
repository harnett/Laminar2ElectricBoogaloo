function LFP_MUA_Raw30k_Writer_DualLam(fdir,toilim,csc_to_phys)
...
mua = MUA_Writer_Mapped_v2(fdir,1000,[],toilim,1000,csc_to_phys);

save('MUA_1k.mat','mua','-v7.3')

clear mua

TmpDat = LFP_Writer_Mapped_v2(fdir,[],1:32,toilim,30000,csc_to_phys);
...
TmpDat = LFP_Writer_Mapped_v2(fdir,[],33:64,toilim,30000,csc_to_phys);
d=int16(TmpDat.trial{1});
